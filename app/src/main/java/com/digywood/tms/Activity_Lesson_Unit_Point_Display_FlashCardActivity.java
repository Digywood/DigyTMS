 ...
 */
public class Activity_Lesson_Unit_Point_Display_FlashCardActivity extends AppCompatActivity {

    Spinner sp_sections;
    RecyclerView question_scroll;
    ImageView iv_quesimg,iv_fullscreen;
    String filedata,status="",testId="",testPath="",studentid="",enrollid="",courseid="",imgPath="",orgid="",studentname="",number="",email="", lessonid = "", lessonunitid = "", lessonunitpointid = "";
...
//            BufferedReader br = new BufferedReader(new FileReader(testPath+"flashAttempts/"+testId+"_01.json"));
        ...
        question_scroll.addOnItemTouchListener(new RecyclerTouchListener(Activity_Lesson_Unit_Point_Display_FlashCardActivity.this,question_scroll,new RecyclerTouchListener.OnItemClickListener() {
            @Override
            public void onClick(View view, int position) {
                ...
                try{
                    ...
                    Animation rotateimage = AnimationUtils.loadAnimation(Activity_Lesson_Unit_Point_Display_FlashCardActivity.this,R.anim.fade_in);
...
//                disableEnableViews(myrlayout);
        ...
        btn_gQues.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mydialog = new Dialog(Activity_Lesson_Unit_Point_Display_FlashCardActivity.this);
                mydialog.getWindow();
...
//                        }
        ...
        if(userMode.mode()) {
           /* mInterstitialAd = new InterstitialAd(this);
            ...
            AdColonUtility.PlayInterstitialAds(Activity_Lesson_Unit_Point_Display_FlashCardActivity.this);
        }
...
//        mControlsView.setVisibility(View.GONE);
    ...
    public ArrayList<String> readJson(String filedata){
        ...
        try{
            ...
            sectionAdp= new ArrayAdapter(Activity_Lesson_Unit_Point_Display_FlashCardActivity.this,android.R.layout.simple_spinner_item,sectionList);
...
//                    disableEnableViews(myrlayout);
    ...
    public  void showAlert(String messege){
        AlertDialog.Builder builder = new AlertDialog.Builder(Activity_Lesson_Unit_Point_Display_FlashCardActivity.this,R.style.ALERT_THEME);
...
//                        Double percentage=Double.parseDouble(String.valueOf(percent));
                        ...
                        Intent intent = new Intent(Activity_Lesson_Unit_Point_Display_FlashCardActivity.this, Activity_Lesson_Unit_Points.class);
...
//                        Double percentage=Double.parseDouble(String.valueOf(percent));
    ...
    public void setData(){
        cAdp = new CardQuestionAdapter(questionList, Activity_Lesson_Unit_Point_Display_FlashCardActivity.this,getScreenSize());
        cAdp.setPoiner(0);
        myLayoutManager = new LinearLayoutManager(Activity_Lesson_Unit_Point_Display_FlashCardActivity.this,LinearLayoutManager.HORIZONTAL,false);
    ...
    public void onResume() {
        ...
        if(userMode.mode()) {
            AdColonUtility.requestInterstitial(Activity_Lesson_Unit_Point_Display_FlashCardActivity.this);
        }
